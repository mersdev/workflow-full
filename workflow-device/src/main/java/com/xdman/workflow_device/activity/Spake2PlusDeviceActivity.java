...
public interface Spake2PlusDeviceActivity {
  ...
  String sendSelectResponseSuccessfully(String vin, String message, String requestId) throws Exception;
  ...
  String sendSpake2PlusResponseSuccessfully(String vin, String message, String requestId) throws Exception;
  ...
  String sendSpake2PlusVerifyResponseSuccessfully(String vin, String message, String requestId) throws Exception;
}
